...
export default function UserPage({ user }) {
    ...
    return (
        <>
            ...
            <div class="card mb-3">
                <div class="row g-0">
                    <div class="col-md-4 p-3 d-flex align-items-bottom" style={{backgroundColor:'#ffedc6'}}>
                        <img src='/Images/profile.jpg' class="img-fluid" style={{height:'auto'}}/>
                    </div>
                    <div class="col-md-8">
                        <div class="card-body">
                        ...
                        <div className='card-action text-center mb-3'>
                            <Link href='/settings'><a className='btn btn-primary'>Edit</a></Link>
                        </div>
                    </div>
                </div>
            </div>
